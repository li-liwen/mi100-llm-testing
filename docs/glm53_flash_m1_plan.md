<!--
Approved deployment plan for the GLM-5.3-Flash W4A16 AutoRound on 8x MI100 deployment.
Status at Milestone 1 (2026-09-12): phases 0-2 complete, 3/4 substantially complete,
6 partially complete (pooled c=1 38.8 tok/s vs the >=50 gate), 5/7 pending.
See Model_Reports/glm53_flash_m1_deployment.md for the milestone report.
-->
